...
def service_handler(call):
    ...
    if service_type in HALF_OFF_SERVICES:
        ...
        # FIXED: Direct contact buttons for each service
        markup = types.InlineKeyboardMarkup(row_width=2)
        markup.add(
            types.InlineKeyboardButton(f"📞 Contact @yrfrnd_spidy", url="https://t.me/yrfrnd_spidy"),
            types.InlineKeyboardButton(f"📞 Contact @Eatsplugsus", url="https://t.me/Eatsplugsus")
        )
        markup.add(
...
👇 **Select your state for state-specific HALF OFF codes:**"""
    ...
    # FIXED: Add direct contact buttons
    markup.add(
        types.InlineKeyboardButton("📞 Contact @yrfrnd_spidy", url="https://t.me/yrfrnd_spidy"),
...
📞 **Contact for {state['name']} Half OFF codes:**"""
        ...
        # FIXED: Direct contact buttons for state
        markup = types.InlineKeyboardMarkup(row_width=2)
        markup.add(
            types.InlineKeyboardButton(f"📞 Contact @yrfrnd_spidy", url="https://t.me/yrfrnd_spidy"),
            types.InlineKeyboardButton(f"📞 Contact @Eatsplugsus", url="https://t.me/Eatsplugsus")
...
📞 **Contact for state-specific Half OFF codes!**"""
    ...
    bot.send_message(call.message.chat.id, response, reply_mup=markup, parse_mode='Markdown')
...
24/7 service available!"""
    ...
    # FIXED: Working direct contact buttons
    markup = types.InlineKeyboardMarkup(row_width=2)
    markup.add(
    ...
    for user_id in users:
        try:
            notification = (
                ...
                f"💰 50% OFF guaranteed\n"
                f"📞 Contact @yrfrnd_spidy or @Eatsplugsus for codes!"
            )
...
def all_messages_handler(message):
    ...
    if not message.text.startswith('/'):
        # FIXED: Direct contact info with clickable buttons
        markup = types.InlineKeyboardMarkup()
        markup.add(
            types.InlineKeyboardButton("📞 Contact @yrfrnd_spidy", url="https://t.me/yrfrnd_spidy"),
            types.InlineKeyboardButton("📞 Contact @Eatsplugsus", url="https://t.me/Eatsplugsus")
        ...
        markup.add(
            types.InlineKeyboardButton("📢 Join Channel", url="https://t.me/flights_bills_b4u"),
            types.InlineKeyboardButton("🚀 Start Bot", callback_data="back_services")
        )
        ...
        bot.send_message(
            ...
            "Click the buttons below to contact or type /start for all services!",
            reply_markup=markup,
            parse_mode='Markdown'
        )
...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .contact-button { display: inline-block; background: #0088cc; color: white; padding: 15px 30px; margin: 10px; border-radius: 10px; text-decoration: none; font-weight: bold; }
            .contact-button:hover { background: #006699; transform: translateY(-2px); }
    ...
    <body>
        <div class="container">
            ...
            <div class="contact-box">
                ...
                <a href="https://t.me/yrfrnd_spidy" class="contact-button">
                    📞 Contact @yrfrnd_spidy
                </a>
                
                <a href="https://t.me/Eatsplugsus" class="contact-button">
                    📞 Contact @Eatsplugsus
                </a>
...
if __name__ == "__main__":
    ...
    try:
        ...
        if render_domain:
            ...
            print(f"📞 Contact Buttons: FIXED & WORKING")
            print(f"👤 Contact 1: @yrfrnd_spidy")
            print(f"👤 Contact 2: @Eatsplugsus")
            print(f"📢 Channel: @flights_bills_b4u")
